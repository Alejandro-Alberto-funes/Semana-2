...
public class Tercerainterfaz extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tercerainterfaz);
        ...
        Button bVolver = (Button)findViewById(R.id.btn4);
        ...
        bVolver.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent vuelva = new
                        Intent(Tercerainterfaz.this, MainActivity.class);
